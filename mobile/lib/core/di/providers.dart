...
final plainDioProvider = Provider<Dio>((ref) => buildDio(ref.watch(apiConfigProvider)));
...
final List<Override> rootOverrides = [
  authServiceProvider.overrideWith((ref) => AuthService(ref.watch(apiClientProvider))),
];
